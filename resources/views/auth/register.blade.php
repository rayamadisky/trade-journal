...
@section('title', 'TradeRitual — Register')
...
<div class="flex-1 flex flex-col justify-center px-6 py-12 page-enter">
    ...
    <div class="text-center mb-10">
        ...
        <h1 class="text-2xl font-bold text-white tracking-tight">Join TradeRitual</h1>
        <p class="text-gray-400 text-sm mt-1">Build the discipline that separates you from the rest.</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-5" id="register-form">
        ...
        {{-- Confirm Password --}}
        <div>
            <label for="register-password-confirm" class="block text-sm font-medium text-gray-300 mb-2">Confirm Password</label>
            <input
                type="password"
